...
def main() -> None:
    ...
    parser.add_argument("--mode", default="hybride",
                        choices=["classique", "hybride", "rerank", "reformule", "graphe", "agent"])
    ...
    if args.mode == "classique":
    ...
    elif args.mode in ("hybride", "rerank", "reformule", "agent"):
        ...
        elif args.mode == "reformule":
            from question_agent import QuestionAgent
            from reranker import Reranker
            candidats = QuestionAgent(hybrid).search(args.question, top_k=20)
            passages = Reranker().rerank(args.question, candidats, args.top_k)
